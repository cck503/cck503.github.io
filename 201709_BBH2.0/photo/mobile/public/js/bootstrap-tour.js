    ...
    Tour = (function() {
        function Tour(options) {
            this._options = $.extend({
                ...
                duration: false,
                basePath: "",
                template: "<div class='popover'>          <div class='arrow'></div>          <h3 class='popover-title'></h3>          <div class='popover-content'></div>          <div class='popover-navigation'>            <div class='btn-group'><button class='btn btn-sm submit_btn' data-role='prev'>上一步</button><button class='btn btn-sm submit_btn' data-role='next'>下一步</button><button class='btn btn-sm delete_btn' data-role='end'>略過</button></div>                      </div>        </div>",
