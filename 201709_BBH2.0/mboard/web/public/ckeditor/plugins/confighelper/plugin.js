...
CKEDITOR.plugins.add( 'confighelper',
{
    ...
    {
        return '.placeholder{ color: #999; font-weight: normal; -webkit-font-smoothing: antialiased;}';
    },
	...
	init : function( editor )
	{
		...
		if (placeholder)
		{
			...
			var content = 'textarea.placeholder { color: #999; font-weight: normal; -webkit-font-smoothing: antialiased;}';
