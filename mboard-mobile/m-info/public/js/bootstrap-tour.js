    ...
    Tour = (function() {
      function Tour(options) {
        this._options = $.extend({
          ...
          orphan: false,
          basePath: "",
          template: "<div class='popover'>          <div class='arrow'></div>          <h3 class='popover-title'></h3>          <div class='popover-content'></div>          <nav class='popover-navigation'>            <div class='btn-group'>              <button class='btn btn-sm btn-default' data-role='prev'>&laquo;</button>              <button class='btn btn-sm btn-default' data-role='next'>&raquo;</button>            </div>            <button class='btn btn-sm btn-default ' data-role='end'>結束教學</button>          </nav>        </div>",
